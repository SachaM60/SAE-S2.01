...
namespace SAE_S2._01
{
    ...
    public class Graphes
    {
        ...
        public string Djikstra(int idDepart, int idArrivee, Dictionary<int, bool> arretFavoris, ref double tempsTrajet)
        {
            ...
            tempsTrajet = Math.Round(distances[idArrivee] * 60, 0);
